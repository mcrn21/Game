...
public:
    ...
    void drawTextureRect(const vec2 &pos, const vec2 &size, const s_ptr<Texture> &texture);
...
private:
    void addDrawCommand(const s_ptr<Texture> &texture, int32_t offset, int32_t count);
