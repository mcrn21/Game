...
Dialog::Dialog()
    : m_center{0.0f}
{
    setFontPixelSize(GuiTheme::metrics.dialog_font_pixel_size);
}
...
void Dialog::updateGeometry()
{
    ...
    m_accept_button->setSize(vec2{m_accept_button->getFont()
                                          ->getFontPage(m_accept_button->getFontPixelSize())
    ...
    m_cancel_button->setSize(vec2{m_cancel_button->getFont()
                                          ->getFontPage(m_cancel_button->getFontPixelSize())
